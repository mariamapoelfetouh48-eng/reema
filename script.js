...
/* ============================================================
   TO MY PRETTY — LOVER'S WEBSITE · PRODUCTION SCRIPT
   Vanilla JS · lightweight · no dependencies

   ────────────────────────────────────────────────────────────
   CUSTOMISE EVERYTHING IN CONFIG — nothing else needs editing.
   Flow: intro → anniversary → memories → letter → surprise
   ============================================================ */

/* ============================================================
   01 · CONFIG — the single source of truth
   ============================================================ */
const CONFIG = {
  ...
  /* ── SCENE 2 · ANNIVERSARY ──────────────────────────────── */
  anniversary: {
    title   : 'HAPPY ANNIVERSARY',          // first word becomes the small top line
    subtitle: 'Another beautiful chapter of us \u2661',
    button  : 'THIS WAS MADE ESPECIALLY FOR YOU',
  },

  /* ── SCENE 3 · MEMORIES ─────────────────────────────────── */
  memories: {
    heading : 'OUR MEMORIES',
    subtitle: 'Fifteen little moments that mean everything to me \u2661',
    ...
    cards   : [
      {
        ...
        date    : '',
        message : 'Some moments become memories, and some memories become home. \u2661',
      },
      {
        image   : 'assets/memory-2.jpg',
        title   : 'WHERE IT ALL BEGAN',
        date    : '',
        message : 'One ordinary day, one extraordinary you \u2014 and everything changed.',
      },
      {
        image   : 'assets/memory-3.jpg',
        title   : 'YOUR SMILE',
        date    : '',
        message : 'Your smile is my favourite view in the entire world. \u2661',
      },
      {
        image   : 'assets/memory-4.jpg',
        title   : 'US, LAUGHING',
        date    : '',
        message : 'With you, even silence feels like a beautiful conversation.',
      },
      {
        image   : 'assets/memory-5.jpg',
        title   : 'EVERY LITTLE THING',
        date    : '',
        message : 'A thousand tiny moments, and every single one of them is you.',
      },
      {
        image   : 'assets/memory-6.jpg',
        title   : 'FOREVER STARTS HERE',
        date    : 'and every day after',
        message : 'Wherever we go, whatever comes \u2014 it\u2019s you. It has always been you. \u2661',
      },
      {
        image   : 'assets/memory-7.jpg',
        title   : 'EVERY GOOD MORNING',
        date    : '',
        message : 'Every morning is softer because it starts with you.',
      },
      {
        image   : 'assets/memory-8.jpg',
        title   : 'YOUR LAUGH',
        date    : '',
        message : 'Your laugh is my favourite song \u2014 I could listen to it forever.',
      },
      {
        image   : 'assets/memory-9.jpg',
        title   : 'LITTLE ADVENTURES',
        date    : '',
        message : 'Anywhere feels like home, as long as I\u2019m beside you.',
      },
      {
        image   : 'assets/memory-10.jpg',
        title   : 'QUIET MOMENTS',
        date    : '',
        message : 'Even our quietest moments are my loudest happiness.',
      },
      {
        image   : 'assets/memory-11.jpg',
        title   : 'YOUR EYES',
        date    : '',
        message : 'I could get lost in your eyes and never ask for directions. \u2661',
      },
      {
        image   : 'assets/memory-12.jpg',
        title   : 'HAND IN HAND',
        date    : '',
        message : 'Your hand in mine turns every road into a journey worth taking.',
      },
      {
        image   : 'assets/memory-13.jpg',
        title   : 'MY CALM, MY CHAOS',
        date    : '',
        message : 'You are both \u2014 my calm and my beautiful chaos \u2014 and I love everything in between.',
      },
      {
        image   : 'assets/memory-14.jpg',
        title   : 'SIMPLY, HAPPILY US',
        date    : '',
        message : 'No big reasons needed \u2014 being us is already my favourite thing.',
      },
      {
        image   : 'assets/memory-15.jpg',
        title   : 'TO MANY MORE',
        date    : 'today, tomorrow, always',
        message : 'This is only the beginning \u2014 I can\u2019t wait for all the memories still to come. \u2661',
      },
    ],
  },
  ...
  letter: {
    ...
    paragraphs: [
      'Three years and two as my wife',
      'But time pass so long with you and i want to spend more time between your arms forever',
      'My Reema you are the one and only the one that I choose and the only love that I truly felt.',
      'Looking to your eyes is worth my whole life to give for them',
      'Looking to your eyes is worth my whole life to give for them',
      'Happy anniversary for you and hope more years with you my lovel and darling baby',
      'your love and husband Omar',
    ],
...
function startMusicFromGesture() {
  ...
  if (a) {
    ...
    const attempt = a.play();
    if (attempt && typeof attempt.catch === 'function') {
      attempt.catch(() => { /* missing/blocked file — continue silently */ });
    }
    fadeVolume(a, CONFIG.system.volume, 1600);
  }
  closeGate();
}
...
function onToggleClick() {
  ...
  if (a.paused) {
    ...
    fadeVolume(a, CONFIG.system.volume, 900);
  } else {
    a.pause();
  }
}
